...
namespace FinancialPortal.Controllers
{
    public class BudgetItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,BudgetId,Created,Name,TargetAmount,CurrentAmount")] BudgetItems budgetItems)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BudgetId,Created,Name,TargetAmount,CurrentAmount")] BudgetItems budgetItems)
        {
            if (ModelState.IsValid)
            {
