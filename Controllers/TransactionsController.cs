...
namespace FinancialPortal.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,BudgetItemId,BankAccountId,OwnerId,Created,Amount,Memo,DipositWithdraw")] Transactions transactions)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BudgetItemId,BankAccountId,OwnerId,Created,Amount,Memo,DipositWithdraw")] Transactions transactions)
        {
            if (ModelState.IsValid)
            {
